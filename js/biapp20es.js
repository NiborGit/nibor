...
function getChapters(){          
    ...
    function showBooks(){
      ...
      xmlhttp.open("GET", "https://firebasestorage.googleapis.com/v0/b/biblia-para-mi.appspot.com/o/BiNTesBooks.json?alt=media&token="+fbi, true);
      xmlhttp.send();
    }
    ...
    function showText(){ 
      ...
      xmlhttp.open("GET", "https://firebasestorage.googleapis.com/v0/b/biblia-para-mi.appspot.com/o/BiNT_RV_es.json?alt=media&token="+fbb, true);
      xmlhttp.send();
    }
    function searchAll(){ 
        document.getElementById("myULbooks").innerHTML = '';
